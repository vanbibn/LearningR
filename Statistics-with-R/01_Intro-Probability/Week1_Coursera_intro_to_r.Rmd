...
#add proportion of boys and girls to dataframe
arbuthnot <- arbuthnot %>%
mutate(propor_boys = boys / total)

arbuthnot <- arbuthnot %>%
mutate(propor_girls = girls / total)

# plot
ggplot(data = arbuthnot, aes(x = year, y = propor_boys)) +
  geom_line()
```
